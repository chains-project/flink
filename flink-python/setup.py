...
try:
    ...
    install_requires = ['py4j==0.10.9.7', 'python-dateutil==2.9.0.post0', 'apache-beam==2.61.0',
    ...
    if sys.version_info < (3, 7):
        ...
        install_requires.append('numpy>=2,<2.2')
        install_requires.append('pandas>=2,<2.3')
        install_requires.append('pyarrow>=18.0.0,<18.1.0')
    else:
        # python 3.7, 3.8 and 3.9 upper limit and M1 chip lower limit,
        install_requires.append('numpy>=2.1.0,<2.2.0')
