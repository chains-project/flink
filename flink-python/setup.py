...
try:
    ...
    install_requires = ['py4j==0.10.9.9', 'python-dateutil==2.9.0.post0', 'apache-beam==2.69.0',
                        'cloudpickle==3.1.2', 'avro-python3>=1.10.2,!=1.9.2,<1.10.3',
